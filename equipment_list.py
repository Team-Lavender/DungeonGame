...
weapons_list = {
    ...
    "bow": {"main_stat": "dex", "dmg": 2, "speed": 0.5, "range": 0, "crit_chance": 5, "type": "ranged", "projectile": "standard_arrow", "cost": 5,
            "name": "Bow"},
    "ricochet_bow": {"main_stat": "dex", "dmg": 15, "speed": 0.5, "range": 0, "crit_chance": 5, "type": "ranged", "projectile": "ricochet_arrow", "cost": 750,
            "name": "Ricochet Bow"},
    "split_bow": {"main_stat": "dex", "dmg": 5, "speed": 0.5, "range": 0, "crit_chance": 5, "type": "ranged", "projectile": "split_arrow", "cost": 200,
            "name": "Split Bow"},
    ...
    "knife": {"main_stat": "dex", "dmg": 1, "speed": 5, "range": 1, "crit_chance": 5, "type": "melee", "cost": 5,
              "name": "Knife"},
    "katana": {"main_stat": "dex", "dmg": 15, "speed": 2, "range": 1, "crit_chance": 7, "type": "melee", "cost": 200,
               "name": "Katana"},
    "lavish_sword": {"main_stat": "str", "dmg": 20, "speed": 2, "range": 1, "crit_chance": 8, "type": "melee", "cost": 1000,
                     "name": "Lavish Sword"},
    "dagger_ruby": {"main_stat": "dex", "dmg": 10, "speed": 3, "range": 1, "crit_chance": 3, "type": "melee", "cost": 50,
                    "name": "Ruby Dagger"},
